...
setup(
    name='AIOwiki',
    version='1.0',
    packages=['AIO', 'venv.lib.python3.6.site-packages.idna', 'venv.lib.python3.6.site-packages.certifi',
              ...
              'venv.lib.python3.6.site-packages.requests', 'venv.lib.python3.6.site-packages.pip-9.0.1-py3.6.egg.pip',
